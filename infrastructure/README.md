...
Scripts for cluster-level operations — node status, software version inventory, upgrade readiness, and configuration audits. Useful for presales assessments and cluster reviews.
