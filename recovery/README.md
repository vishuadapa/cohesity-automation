...
python3 list_snapshots.py --object "vm-prod-01" --cluster prod-cluster --ca-bundle /path/to/ca.pem
```
...
python3 restore_vm.py --vm "vm-prod-01" --cluster prod-cluster --ca-bundle /path/to/ca.pem
```
