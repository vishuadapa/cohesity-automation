...
|--------|--------|-------------|------|
| `cohesity_protection_report.py` | [docs](cohesity_protection_report.md) | Protection group run status, timing, object counts, data sizes, replication/archive status, storage consumed | Direct / Helios |
