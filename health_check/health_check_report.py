...
try:
    ...
    def get_auth_token(cluster, username, password, domain, mfa_code=None,
        ...
        try:
            ...
            print("    • Shell quoting?    If your password contains $ or ! wrap it in")
            print("      single quotes: --password 'Cohe$1ty'  (single quotes prevent")
            print("      shell variable expansion; double quotes do not).")
